  ...
  <div style="position: relative">
    ...
    >
      <div style="display: flex; align-items: center; white-space: nowrap">
        <v-img :width="60" :height="68" :src="fp('index/icoguohui.png')" />
        <div style="font-size: 40px; margin-left: 10px; font-weight: 600">
          全国电子印章管理与服务平台省级平台
        </div>
      </div>
      <div
    ...
    >
      ...
      >
        <v-img :width="60" :height="68" :src="fp('index/icoguohui.png')" />
        <div style="font-size: 20px; margin-top: 10px; font-weight: 600">
          全国电子印章管理与服务平台省级平台
        </div>
      </div>
      <div
    ...
    <el-carousel
      :style="{ width: `${mainStore.deviceInfo.width}px` }"
    ...
    >
      <el-carousel-item v-for="(banner, i) in banners" :key="i">
        <v-img
          cover
          :width="mainStore.deviceInfo.width"
          :height="mainStore.deviceInfo.height"
          :src="banner"
        />
      </el-carousel-item>
    </el-carousel>
    ...
    >
      <div
        :style="{
          width: mainStore.isMobile
            ? `${mainStore.deviceInfo.width}px`
            : `${mainStore.screen.width - 260}px`,
          height: mainStore.isMobile
            ? `calc(${mainStore.deviceInfo.height}px - 20vh)`
            : `${mainStore.screen.height - 180}px`,
          display: `flex`
        }"
      >
        <div
        ...
        >
          ...
          >
            <img
              :alt="item.label"
              :width="mainStore.isMobile ? 20 : 30"
              :height="mainStore.isMobile ? 20 : 30"
              :src="item.icon"
            />
            <div
              :class="{
    ...
    <div
      ...
      class="part2"
      :style="{
        background: `url('${fp('index/part2bg.jpg')}')`,
        padding: isMobile ? `50px 0 40px 0` : `80px 0 100px 0`,
        width: `100vw`,
        display: 'flex',
    ...
    >
      ...
      >
        ...
        >
          构建场景化电子签章应用，依照业务需求提供丰富的行业及场景的签字签章应用选项，满足多样化签署需求，围绕政务服务、能源、医疗、金融、教育、电商、快消等行业，输出细分领域解决方案，提供全面市场支持服务。
        </p>
        <div style="display: flex; justify-content: center; width: 100%">
          ...
          >
            ...
            >
              ...
              />
              <div
                style="margin-top: 25px; margin-bottom: 30px; font-size: 20px"
              >
                {{ item.label }}
              </div>
            </div>

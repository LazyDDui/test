...
const downloadBA = (r) => {
  http.post("/app/seal/viewRecordUni", {
    ...
    downloadPdf(res.data.fileTempUrl.replace('http://182.151.13.73:9190', ''))
  });
};
...
const searchSubjectName = () => {
  loading.value = true;
  http.post("/biz/seal/record/query", {
    data:{
        ...
        <el-table-column label="操作" align="center" width="500px">
          <template #default="scope">
            <div style="white-space: nowrap">
              <el-button type="text" @click="toSeal(scope.row)">查看印章</el-button>
    ...
    <div v-if="type == '1'">
      ...
      >
        ...
        <el-table-column label="操作" align="center" width="180px">
          <template #default="scope">
            <el-button type="text" @click="downloadBA(scope.row)">下载备案</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
  ...
  >
    <el-form :model="form" label-width="auto" style="max-width: 300px">
      ...
      <el-form-item label="个人身份证号">
        <el-input v-model="form.idCard" placeholder="请输入个人身份证号"></el-input>
      </el-form-item>
      <el-form-item label="个人实名手机号码">
        <el-input v-model="form.tel" placeholder="请输入个人实名手机号码"></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
  ...
  >
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="companyConfirm()">
          确定
        </el-button>
      </div>
    </template>
